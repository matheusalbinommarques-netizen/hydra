...
| `/hydra-prepare-delivery` | `<item-id>` | Atualiza backlog/`PROJECT_STATUS.md`/`CHANGELOG.md`/`TASKS.md` a partir do diff não commitado, reavalia o nível | Sim (só documentação) | Não | Não |
