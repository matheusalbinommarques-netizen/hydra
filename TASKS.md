...
**Status atual:** preparação visual e funcional do Release 0  
...
- [x] Consolidar a baseline inicial de planejamento.
...
- [ ] Registrar a escolha da stack no ADR-001.
- [ ] Aprovar a arquitetura inicial do código.
- [ ] Criar o projeto da aplicação.
- [ ] Desenvolver o Walking Skeleton.

## Primeiras quatro telas a definir
...
- [ ] Implementar importação JSON.
- [ ] Criar testes automatizados do motor de orientação.
- [ ] Criar teste da jornada completa.
