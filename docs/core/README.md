...
- `CURRENT_WORK.json`: ponteiro operacional transitório — qual é o Stage/corte atual (consumido por `hydra-state.mjs`/`hydra-delivery-guard.mjs`, não é histórico nem especificação).
